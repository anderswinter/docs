...
Se the [MDM setup guide](/Tech/mdm-deployment-instructions) for details on running silent installs using command line arguments.    
</Note>
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/watch?v=Y504kwXNh-Q"
