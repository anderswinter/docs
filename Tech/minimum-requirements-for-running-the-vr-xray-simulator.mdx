...
<Note>
  Workstation graphicscards from Nvidia (such as the RTX Pro X000 series) - found in Lenovo and other vendors -  are known to be compatible. Consult Nvidias offical list on their website [here.](https://www.nvidia.com/en-us/design-visualization/solutions/vr-ready-systems/)
</Note>
