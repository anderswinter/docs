...
Download the VitaSim Launcher installer from the [Download page](https://support.xraysim.com/Download/upgrade-guide#) and run it on the station. The installer places the launcher and its scripts under `C:\VitaSim\`.
