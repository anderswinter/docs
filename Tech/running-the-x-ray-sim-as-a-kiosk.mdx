...
Download the VitaSim Launcher installer from the [Download page](/Download/download) and run it on the station. The installer places the launcher and its scripts under `C:\VitaSim\`.
