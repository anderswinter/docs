...
Download the VitaSim Launcher installer from the import LauncherLatest from '/snippets/launcher-latest.mdx';

<LauncherLatest /> and run it on the station. The installer places the launcher and its scripts under `C:\VitaSim\`.
